...
class KeySpec extends Specification {
  def key = new Key(KeyType.PRIMARY, ['a', 'b', 'c'], false, false, null)
  def key2a = new Key(KeyType.PRIMARY, ['a', 'b', 'c'], false, false, null)
  def key2b = new Key(KeyType.PRIMARY, ['c', 'b', 'a'], false, false, null)
  def key3 = new Key(KeyType.PRIMARY, ['a', 'b', 'z'], false, false, null)
