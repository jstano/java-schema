...
public class FlywayMigrationExecutor {
  ...
  public void executeSqlFile(DatabaseType databaseType, File sqlFile, Connection connection) throws IOException {
    ...
    try {
      ...
      executeFlyway(databaseType, "filesystem:" + tempDir.toAbsolutePath(), connection, sqlFile.getName());
    }
    finally {
  ...
  public void executeClasspathSqlLocation(DatabaseType databaseType, String classpathResource, Connection connection) {
    Path tempDir;
    try {
    ...
    try {
      ...
      executeFlyway(databaseType, "filesystem:" + tempDir.toAbsolutePath(), connection, classpathResource);
    }
    finally {
      deleteDirectory(tempDir.toFile());
    }
  ...
  private void executeFlyway(DatabaseType databaseType, String location, Connection connection, String logName) {
  ...
  private void copyClasspathResourceToFile(String classpathResource, File targetFile) throws FlywayRuntimeException {
