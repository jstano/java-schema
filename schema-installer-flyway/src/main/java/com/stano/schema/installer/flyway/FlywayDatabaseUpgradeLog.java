...
public class FlywayDatabaseUpgradeLog {
  ...
  private String getDatabaseUpgradeLogDDL(DatabaseType databaseType) {
    return switch (databaseType) {
      ...
      case MYSQL -> "create table databaseupgradelog (ID integer not null auto_increment,StartDateTime datetime not null,EndDateTime datetime,ChangeLogName text,Error text,constraint pk_databaseupgradelog primary key (ID))";//NON-NLS
      case SQLITE -> "create table databaseupgradelog (ID integer primary key autoincrement,StartDateTime text not null,EndDateTime text,ChangeLogName text,Error text)";//NON-NLS
    };
  }
